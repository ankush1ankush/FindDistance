...
function SubmitForm() {
  ...
  const handleIncrease = () => {
    setStopInput([
      ...stopInput,
      <Stop isLoaded={isLoaded} setwaypoint={setwaypoint} />,
    ]);
  };
  ...
  function findWaypoint() {
    const waypointsArray = stopRef.current.value
  ...
  return (
    <div className="container">
      <div className="heading">
        Let's calculate <p className="headerBold">distance</p> from Google maps
      </div>
          ...
          <div className="formContainer">
            <div className="InputForm">
              <div className="Input">
                ...
                <div className="inputField" type="text">
              ...
              <div className="Input">
                ...
                <div className="inputField" type="text">
                  ...
                  <Autocomplete>
                    <input name="stop" placeholder="Stop" ref={stopRef}></input>
                  </Autocomplete>
                </div>
              </div>
              ...
              <div className="Addbutton" onClick={handleIncrease}>
                {" "}
                <AddCircleOutlineIcon />
                <div className="addContent">Add another stop</div>
              </div>
            ...
            <div className="buttonContainer">
              <button className="submitButton" onClick={calculateRoute}>
                Calculate
              </button>
            </div>
          </div>
          {distance && duration && (
            <div className="calculation">
              ...
              <div className="message">
                The distance between <p className="cityName">{origin} </p> and{" "}
                <p className="cityName"> {destination}</p> via the selected
                route is {Number(distance).toFixed(2)} kms and ETA is{" "}
                {Number(duaration).toFixed(2)} hours{" "}
              </div>
            </div>
          )}
        </div>
